...
<div>
    ...
    <div class="p-4">
        ...
        <div class="flex p-4">
            <a href="#" @click.prevent="updateCategory" class="w-52 p-2 text-center h-12 bg-indigo-600 hover:bg-indigo-800 transition-all duration-700 rounded-full shadow-xs text-white text-base font-semibold leading-6">Send Category</a>
        </div>
