...
export default {
    ...
    methods: {
        deleteCategory(category) {
            axios.delete(route('admin.categories.destroy', category.id)).then(res => {
...
<template>
    <div>
        ...
        <div>
            <h1 class="text-center p-4">Categories Table</h1>
                        ...
                        <div class="overflow-x-auto w-full  border rounded-lg border-gray-300">
                            <table class="w-full rounded-xl">
                                ...
                                <tr v-for="category in categoriesData"
                                    ...
                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        <Link
                                            class="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-green-500 hover:text-white "
